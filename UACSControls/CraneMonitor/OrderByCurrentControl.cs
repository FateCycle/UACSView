...
{
    public partial class OrderByCurrentControl : UserControl
    {
        public OrderByCurrentControl()
        {
            InitializeComponent();
        }
        private void InitDataInfo()
        {
            lblCmdStatus.Text = lblFromStockNo.Text = lblToStockNo.Text = lblMatNo1.Text = lblMatNo2.Text = lblObjectType.Text = lblOrderNo.Text = lblOrderType.Text =
        ...
        {
            InitDataInfo();
            lblOrderNo.Text = craneOrderCurrent.ORDER_NO.ToString();
        ...
        private void lblCmdStatus_Click(object sender, EventArgs e)
        {
