...
namespace UACSControls
{
    public class conParkingCarModel
    {
        ...
        public void conInit(Panel theBayPanel, string theBayNO, string theTagServiceName, long _baySpaceX, long _baySpaceY, bool _xAxisRight, bool _yAxisDown)
        {
            try
            {
        ...
        public void refreshControl()
        {
            try
            {
                ...
                //LogManager.WriteProgramLog("111111");
                foreach (ParkingBase theSaddleInfo in theCarInfoInBay.DicCarMessage.Values)
                {
                    ...
                    else
                    {
                        ...
                        //LogManager.WriteProgramLog(theSaddleInfo.ParkingName);
                    }
            ...
            {
                LogManager.WriteProgramLog(ex.Message,ex.StackTrace);
            }
        }
