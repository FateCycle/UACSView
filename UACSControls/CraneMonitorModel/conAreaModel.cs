...
namespace UACSControls
{
    public class conAreaModel
    {
     ...
     //   private AreaInfo theAreaInfoInBay1 = new AreaInfo();
        ...
        /// 显示小区需要的详细信息
        /// </summary>
        public void conInit(Panel theBayPanel, string theBayNO, string theTagServiceName, long _baySpaceX, long _baySpaceY, bool _xAxisRight, bool _yAxisDown, AreaInfo.AreaType _AreaType)
        {
            try
            {
                ...
                panelWidth = theBayPanel.Width;
                panelHeight = theBayPanel.Height;
                xAxisRight = _xAxisRight;
                yAxisDown = _yAxisDown;
                theAreaInfoInBay.conInit(theBayNO, _AreaType, theTagServiceName);
              //  theAreaInfoInBay1.conInit(theBayNO, _AreaType, theTagServiceName);
                refreshControl();
            }
            catch (Exception ex)
            {
        ...
        //conPalpit
        public void conPalpit(Panel theBayPanel, string theBayNO, string theTagServiceName, long _baySpaceX, long _baySpaceY, bool _xAxisRight, bool _yAxisDown, AreaInfo.AreaType _AreaType)
        {
            try
            {
                bayPanel = theBayPanel;
