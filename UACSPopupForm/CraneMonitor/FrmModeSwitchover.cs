...
namespace UACSPopupForm
{
    public partial class FrmModeSwitchover : Form
    {
        ...
        {
            if (MessageBox.Show(string.Format("是否确定手动"), "提示", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
            {
        ...
        {
            if (MessageBox.Show(string.Format("是否确定复位"), "提示", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
            {
                isPopupMessage = true;
                if (isClickReset)
                {
        ...
        {
            if (MessageBox.Show(string.Format("是否确定自动"), "提示", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
            {
                isPopupMessage = true;
                if (isClickAuto)
                {
        ...
        {
            if (MessageBox.Show(string.Format("是否请求停车"), "提示", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
            {
