...
namespace UACSDAL
{
    ...
    public class UnitSaddleBase
    {
        ...
        private string tagAdd_LockRequest_FEEDBACK;
         /// <summary>
        /// 锁定请求的反馈
        /// </summary>
        public string TagAdd_LockRequest_FEEDBACK
        {
            get { return tagAdd_LockRequest_FEEDBACK; }
            set { tagAdd_LockRequest_FEEDBACK = value; }
        }

        private string tagAdd_LockRequest_SET;
        /// <summary>
        /// 锁定请求
        /// </summary>
        public string TagAdd_LockRequest_SET
        {
            get { return tagAdd_LockRequest_SET; }
            set { tagAdd_LockRequest_SET = value; }
        }
        ...
        private long tagVal_LockRequest_FEEDBACK;
        /// <summary>
        /// 锁定请求的反馈信号点值
        /// </summary>
        public long TagVal_LockRequest_FEEDBACK
        {
            get
            {
                return tagVal_LockRequest_FEEDBACK;
            }
            set
            {
                tagVal_LockRequest_FEEDBACK = value;
            }
        }

        private long tagVal_LockRequest_SET;
        /// <summary>
        /// 锁定请求信号点值
        /// </summary>
        public long TagVal_LockRequest_SET
        {
            get
            {
                return tagVal_LockRequest_SET;
            }
            set
            {
                tagVal_LockRequest_SET = value;
            }
        }
