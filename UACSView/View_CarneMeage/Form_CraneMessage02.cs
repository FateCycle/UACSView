...
{
    public partial class Form_CraneMessage02 : FormBase
    {
     ...
     as Baosight.iSuperframe.Authorization.Interface.IAuthorization;
        ...
        public Form_CraneMessage02()
        {
            InitializeComponent();
        }

        private void Form_CraneMessage02_Load(object sender, EventArgs e)
        {
            dataGridView1.AutoGenerateColumns = false;
            try
            {
                string sqlText = @"SELECT * FROM UACS_LASER_LINE_EXIT_INFO";
