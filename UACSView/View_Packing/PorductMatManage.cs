    ...
    public partial class PorductMatManage : FormBase
    {
        ...
        private void GetComboxOnParkingByBay()
        {
            ...
            try
            {
                string str1 = "";
                string str2 = "";
                if (cmbArea.Text.Contains("Z53"))
                {
                    str1 = "Z53";
                    str2 = "";
                }
                else if (cmbArea.Text.Contains("Z52"))
                {
                    str1 = "Z52";
                    str2 = "";
                }
                else if (cmbArea.Text.Contains("Z51"))
                {
                    str1 = "Z51";
                    str2 = "";
                }
        ...
        private void btnCarFrom_Click(object sender, EventArgs e)
        {
            ...
            if (cbbPacking.Text.Contains('Z'))
            {
                ...
                if (dr == DialogResult.OK)
                {
                    ...
                    txtCoilsWeight.BackColor = Color.White;
                    txtSelectGoove.Text = "";
                    UACSDAL.HMILogger.WriteLog(btnCarFrom.Text, "车离：" + cbbPacking.Text, UACSDAL.LogLevel.Info, this.Text);
                }
                isStowage = false;
                hasParkSize = false;
            }
        ...
        private string GetParkStatus(string parkingNO)
        {
            ...
            try
            {
                ...
                using (IDataReader rdr = DBHelper.ExecuteReader(sqlText))
                {
                    while (rdr.Read())
                    {
                        ret = UACSDAL.ManagerHelper.JudgeStrNull(rdr["PARKING_STATUS"]);
                    }
                }
            }
            catch (Exception ex)
                ...
                using (IDataReader rdr = DBHelper.ExecuteReader(sql))
                {
                    while (rdr.Read())
                    {
                        ...
                        if (cbbPacking.Text.Contains("Z3"))
                        {
                            ...
                            {
                                parkZ53A2.SetPark(JudgeStrNull(rdr["PARKING_NO"]), JudgeStrNull(rdr["ISLOADED"]), JudgeStrNull(rdr["PARKING_STATUS"]), JudgeStrNull(rdr["CAR_NO"]), JudgeStrNull(rdr["CAR_TYPE"]));
                            }
                            else if (rdr["PARKING_NO"].ToString().Trim() == "Z33A1")
                            {
                                parkZ53A1.SetPark(JudgeStrNull(rdr["PARKING_NO"]), JudgeStrNull(rdr["ISLOADED"]), JudgeStrNull(rdr["PARKING_STATUS"]), JudgeStrNull(rdr["CAR_NO"]), JudgeStrNull(rdr["CAR_TYPE"]));
                            }
                        }
                        else if (cbbPacking.Text.Contains("Z5") && cmbArea.Text.Trim().Contains("7-1"))
                        {
                            ...
                            {
                                parkZ51A2.SetPark(JudgeStrNull(rdr["PARKING_NO"]), JudgeStrNull(rdr["ISLOADED"]), JudgeStrNull(rdr["PARKING_STATUS"]), JudgeStrNull(rdr["CAR_NO"]), JudgeStrNull(rdr["CAR_TYPE"]));

                            }
                            else if (rdr["PARKING_NO"].ToString().Trim() == "Z51A2")
                            {
                                parkZ51A1.SetPark(JudgeStrNull(rdr["PARKING_NO"]), JudgeStrNull(rdr["ISLOADED"]), JudgeStrNull(rdr["PARKING_STATUS"]), JudgeStrNull(rdr["CAR_NO"]), JudgeStrNull(rdr["CAR_TYPE"]));
                            }
                            else if (rdr["PARKING_NO"].ToString().Trim() == "Z52A1")
                            {
                                parkZ52A2.SetPark(JudgeStrNull(rdr["PARKING_NO"]), JudgeStrNull(rdr["ISLOADED"]), JudgeStrNull(rdr["PARKING_STATUS"]), JudgeStrNull(rdr["CAR_NO"]), JudgeStrNull(rdr["CAR_TYPE"]));
                            }
                            else if (rdr["PARKING_NO"].ToString().Trim() == "Z52A2")
                            {
                                parkZ52A1.SetPark(JudgeStrNull(rdr["PARKING_NO"]), JudgeStrNull(rdr["ISLOADED"]), JudgeStrNull(rdr["PARKING_STATUS"]), JudgeStrNull(rdr["CAR_NO"]), JudgeStrNull(rdr["CAR_TYPE"]));
                            }
        ...
        private bool GetParkInfoByBay()
        {
            try
            {
                ...
                using (IDataReader rdr = DBHelper.ExecuteReader(sql))
                {
                    ...
                    {
                        //Z3
                        if (cbbPacking.Text.Contains("R-24"))
                        {
                            if (rdr["PARKING_NO"].ToString().Trim() == "TRE1")
                            {
                                parkZ53A1.SetPark(JudgeStrNull(rdr["PARKING_NO"]), JudgeStrNull(rdr["ISLOADED"]), JudgeStrNull(rdr["PARKING_STATUS"]), JudgeStrNull(rdr["CAR_NO"]), JudgeStrNull(rdr["CAR_TYPE"]));
                            }
                            else if (rdr["PARKING_NO"].ToString().Trim() == "TRE2")
                            {
                                parkZ53A2.SetPark(JudgeStrNull(rdr["PARKING_NO"]), JudgeStrNull(rdr["ISLOADED"]), JudgeStrNull(rdr["PARKING_STATUS"]), JudgeStrNull(rdr["CAR_NO"]), JudgeStrNull(rdr["CAR_TYPE"]));
                            }
                            parkZ52A2.SetPark("","","","","");
                        ...
                        else if (cbbPacking.Text.Contains("R-25"))
                        {
                            if (rdr["PARKING_NO"].ToString().Trim() == "TRE3")
                            {
                                parkZ51A1.SetPark(JudgeStrNull(rdr["PARKING_NO"]), JudgeStrNull(rdr["ISLOADED"]), JudgeStrNull(rdr["PARKING_STATUS"]), JudgeStrNull(rdr["CAR_NO"]), JudgeStrNull(rdr["CAR_TYPE"]));
                        ...
                        else if (cbbPacking.Text.Contains("R-26"))
                        {
                            //Z5 52
                            if (rdr["PARKING_NO"].ToString().Trim() == "TRE4")
                            {
                                parkZ51A1.SetPark(JudgeStrNull(rdr["PARKING_NO"]), JudgeStrNull(rdr["ISLOADED"]), JudgeStrNull(rdr["PARKING_STATUS"]), JudgeStrNull(rdr["CAR_NO"]), JudgeStrNull(rdr["CAR_TYPE"]));

                            }
                            if (rdr["PARKING_NO"].ToString().Trim() == "TRE5")
                            {
                                parkZ51A2.SetPark(JudgeStrNull(rdr["PARKING_NO"]), JudgeStrNull(rdr["ISLOADED"]), JudgeStrNull(rdr["PARKING_STATUS"]), JudgeStrNull(rdr["CAR_NO"]), JudgeStrNull(rdr["CAR_TYPE"]));
                        ...
                        else if (cbbPacking.Text.Contains("R-27"))
                        {
                            //Z5 53
                            if (rdr["PARKING_NO"].ToString().Trim() == "TRE6")
                            {
                                parkZ51A1.SetPark(JudgeStrNull(rdr["PARKING_NO"]), JudgeStrNull(rdr["ISLOADED"]), JudgeStrNull(rdr["PARKING_STATUS"]), JudgeStrNull(rdr["CAR_NO"]), JudgeStrNull(rdr["CAR_TYPE"]));

                            }
                            else if (rdr["PARKING_NO"].ToString().Trim() == "TRE7")
                            {
                                parkZ51A2.SetPark(JudgeStrNull(rdr["PARKING_NO"]), JudgeStrNull(rdr["ISLOADED"]), JudgeStrNull(rdr["PARKING_STATUS"]), JudgeStrNull(rdr["CAR_NO"]), JudgeStrNull(rdr["CAR_TYPE"]));
                            }
                            else if (rdr["PARKING_NO"].ToString().Trim() == "TRE8")
                            {
                                parkZ52A1.SetPark(JudgeStrNull(rdr["PARKING_NO"]), JudgeStrNull(rdr["ISLOADED"]), JudgeStrNull(rdr["PARKING_STATUS"]), JudgeStrNull(rdr["CAR_NO"]), JudgeStrNull(rdr["CAR_TYPE"]));
                            }
                            else if (rdr["PARKING_NO"].ToString().Trim() == "TRE9")
                            {
                                parkZ52A2.SetPark(JudgeStrNull(rdr["PARKING_NO"]), JudgeStrNull(rdr["ISLOADED"]), JudgeStrNull(rdr["PARKING_STATUS"]), JudgeStrNull(rdr["CAR_NO"]), JudgeStrNull(rdr["CAR_TYPE"]));
                            }
                            parkZ53A2.SetPark("", "", "", "", "");
            ...
            try
            {
                ...
                if (parkNO != "请选择" || parkNO != "")
                {
                    ...
                    if (dr == DialogResult.OK)
                    {
                        ...
                        UACSDAL.HMILogger.WriteLog(btnOperateStrat.Text, "作业开始：" + cbbPacking.Text, UACSDAL.LogLevel.Info, this.Text);
            ...
            try
            {
                ...
                if (parkNO != "请选择" || parkNO != "")
                {
                    ...
                    if (dr == DialogResult.OK)
                    {
                        ...
                        UACSDAL.HMILogger.WriteLog(btnOperatePause.Text, "作业暂停：" + parkNO, UACSDAL.LogLevel.Info, this.Text);
                        btnOperateStrat.ForeColor = Color.White;
                        btnOperatePause.ForeColor = Color.Orange;
                    }
                }
        ...
        private void btnSeleceByMat_Click(object sender, EventArgs e)
        {
            ...
            if (cbbPacking.Text.Trim() != "请选择" && cbbPacking.Text.Trim() != "" && cbbPacking.Text.Trim().Contains('Z'))
            {
                selectCoilF.ParkNO = cbbPacking.Text.Trim();  //Z53A1
                selectCoilF.TransferValue += selectCoilF_TransferValue;
        ...
        private void labTips_Click(object sender, EventArgs e)
        {

        }

        private void parkLaserOut1_Load(object sender, EventArgs e)
        {
        ...
        private void PorductMatManage_Load_1(object sender, EventArgs e)
        {

        }

        private void parkZ52A1_Load(object sender, EventArgs e)
        {
